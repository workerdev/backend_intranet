...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "resources/assets/js/highlight",
      "jquery": "resources/assets/js/jquery.min", // 1.11.3
      "bootstrap": "resources/assets/js/bootstrap.min"
    },
    shim: {
      "bootstrap": ["jquery"]
    }
  ...
  function goLoadSrc(filenames) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "resources/assets/js/" + filename;
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "resources/assets/css/highlight.css";
head.appendChild(link);
...
function goSamples() {
  ...
  for (var i = 0; i < l; i++) {
    ...
    img.height = "200";
    img.src = "resources/assets/images/screenshots/" + imgname + ".png";
