...
class ControlCorrelativoController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->render('controlcorrelativo/index.html.twig', array('objects' => $controlcorrelativo, 'gerencia' => $Gerencia, 'parents' => $parent, 'children' => $child, 'permisos' => $permisos));
    }
