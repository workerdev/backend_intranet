...
{   
    ...
    public function index()
    {
        ...
        return $this->render('unidadmedida/index.html.twig', array('objects' => $unidadmedida, 'parents' => $parent, 'children' => $child, 'permisos' => $permisos, 'docderiv' => $docderiv, 'fcaprobjf' => $fcaprobjf, 'fcaprobgr' => $fcaprobgr));
    }
