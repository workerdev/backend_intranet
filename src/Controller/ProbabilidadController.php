...
{   
    ...
    public function index()
    {
        ...
        return $this->render('probabilidad/index.html.twig', array('objects' => $probabilidad, 'parents' => $parent, 'children' => $child, 'permisos' => $permisos, 'docderiv' => $docderiv, 'fcaprobjf' => $fcaprobjf, 'fcaprobgr' => $fcaprobgr));
    }
