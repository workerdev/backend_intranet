...
class NormaDocumentoController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->render('normadocumento/index.html.twig', array('objects' => $NormaDocumento, 'tipo' => $TipoNorma, 'documento' => $Documento, 'parents' => $parent, 'children' => $child, 'permisos' => $permisos));
    }
