...
class ConfiguracionModFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $catalogo1->setDuenio('Mauricio Vallejo');
        $catalogo1->setUrl('');
        ...
        $catalogo3->setDuenio('Mauricio Vallejo');
        $catalogo2->setUrl('');
        ...
        $catalogo4->setDuenio('Ramiro Iriarte');
        $catalogo2->setUrl('');
        ...
        $catalogo5->setDuenio('David Atahuichi');
        $catalogo2->setUrl('');
        ...
        $catalogo6->setDuenio('David Atahuichi');
        $catalogo2->setUrl('');
        ...
        $catalogo7->setDuenio('Carlos Quiroga');
        $catalogo2->setUrl('');
        ...
        $catalogo8->setDuenio('');
        $catalogo2->setUrl('http://intranet/mesaayuda/ma_principal.html');
        ...
        $catalogo10->setDuenio('');
        $catalogo2->setUrl('http://intranet/hysweb/login/');
        ...
        $catalogo11->setDuenio('');
        $catalogo2->setUrl('alcoholemia.elfec.com');
...
- Reportes varios en rangos de fechas y horas."');
        $catalogo12->setDuenio('');
        $catalogo2->setUrl('rastreo.elfec.com');
...
Trámite de Cambio de Nombre -Consulta General de Cuentas -Trámite de Cambio de Ubicación"');
        $catalogo13->setDuenio('');
        $catalogo2->setUrl('webserver/SGC/');
        ...
        $catalogo14->setDuenio('');
        $catalogo2->setUrl('http://serverweb/SGT/');
        ...
        $catalogo15->setDuenio('');
        $catalogo2->setUrl('http://sisman.elfec.com/');
...
Permite  georeferenciar el suministro seleccionado y desplegarlo en el mapa de GoogleMaps de manera que facilite su ubicación al cortador que tenga algún problema en encontrar al cliente."');
        $catalogo16->setDuenio('');
        $catalogo2->setUrl('https://cortes.elfec.com/');
...
5. HERRAMIENTAS: Módulo compuesto por las opciones: Calendario: Muestra la calendarización de los diferentes tipos de tareas y el estado en el que se encuentran."');
        $catalogo17->setDuenio('');
        $catalogo2->setUrl('http://elflwb01/sgcst/');
...
Reportes: Reimpresion de certificados generados por el CERMED (sistema anterior)"');
        $catalogo18->setDuenio('');
        $catalogo2->setUrl('http://elflwb01/sglabmed/');
