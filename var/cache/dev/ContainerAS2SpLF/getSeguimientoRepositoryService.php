...
// Returns the private 'App\Repository\SeguimientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SeguimientoRepository.php';

return $this->privates['App\Repository\SeguimientoRepository'] = new \App\Repository\SeguimientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
