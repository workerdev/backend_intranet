...
// Returns the private 'App\Repository\ProbabilidadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProbabilidadRepository.php';

return $this->privates['App\Repository\ProbabilidadRepository'] = new \App\Repository\ProbabilidadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
