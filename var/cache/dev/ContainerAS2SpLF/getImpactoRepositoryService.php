...
// Returns the private 'App\Repository\ImpactoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ImpactoRepository.php';

return $this->privates['App\Repository\ImpactoRepository'] = new \App\Repository\ImpactoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
