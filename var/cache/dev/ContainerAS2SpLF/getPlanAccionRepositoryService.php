...
// Returns the private 'App\Repository\PlanAccionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PlanAccionRepository.php';

return $this->privates['App\Repository\PlanAccionRepository'] = new \App\Repository\PlanAccionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
