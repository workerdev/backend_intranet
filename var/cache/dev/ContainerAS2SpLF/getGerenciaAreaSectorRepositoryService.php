...
// Returns the private 'App\Repository\GerenciaAreaSectorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GerenciaAreaSectorRepository.php';

return $this->privates['App\Repository\GerenciaAreaSectorRepository'] = new \App\Repository\GerenciaAreaSectorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
