...
// Returns the private 'App\Repository\NormaDocumentoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NormaDocumentoRepository.php';

return $this->privates['App\Repository\NormaDocumentoRepository'] = new \App\Repository\NormaDocumentoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
