...
// Returns the private 'App\Repository\FichaProcesosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FichaProcesosRepository.php';

return $this->privates['App\Repository\FichaProcesosRepository'] = new \App\Repository\FichaProcesosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
