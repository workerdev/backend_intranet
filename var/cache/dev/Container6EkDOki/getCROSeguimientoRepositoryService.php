...
// Returns the private 'App\Repository\CROSeguimientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CROSeguimientoRepository.php';

return $this->privates['App\Repository\CROSeguimientoRepository'] = new \App\Repository\CROSeguimientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
