...
// Returns the private 'App\Repository\TipoDatoEmpresarialRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoDatoEmpresarialRepository.php';

return $this->privates['App\Repository\TipoDatoEmpresarialRepository'] = new \App\Repository\TipoDatoEmpresarialRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
