...
// Returns the private 'App\Repository\DocumentoBajaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentoBajaRepository.php';

return $this->privates['App\Repository\DocumentoBajaRepository'] = new \App\Repository\DocumentoBajaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
