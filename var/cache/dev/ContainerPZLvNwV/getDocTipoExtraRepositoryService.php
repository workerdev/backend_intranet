...
// Returns the private 'App\Repository\DocTipoExtraRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocTipoExtraRepository.php';

return $this->privates['App\Repository\DocTipoExtraRepository'] = new \App\Repository\DocTipoExtraRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
