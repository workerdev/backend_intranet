...
// Returns the private 'App\Repository\DocumentosAsoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentosAsoRepository.php';

return $this->privates['App\Repository\DocumentosAsoRepository'] = new \App\Repository\DocumentosAsoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
