...
// Returns the private 'App\Repository\AreaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AreaRepository.php';

return $this->privates['App\Repository\AreaRepository'] = new \App\Repository\AreaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
