...
// Returns the private 'App\Repository\SeguimientoPlanRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SeguimientoPlanRepository.php';

return $this->privates['App\Repository\SeguimientoPlanRepository'] = new \App\Repository\SeguimientoPlanRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
