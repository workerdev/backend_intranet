...
// Returns the private 'App\Repository\AuditoriaEquipoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AuditoriaEquipoRepository.php';

return $this->privates['App\Repository\AuditoriaEquipoRepository'] = new \App\Repository\AuditoriaEquipoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
