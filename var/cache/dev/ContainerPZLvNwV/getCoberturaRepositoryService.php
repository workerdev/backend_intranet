...
// Returns the private 'App\Repository\CoberturaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CoberturaRepository.php';

return $this->privates['App\Repository\CoberturaRepository'] = new \App\Repository\CoberturaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
