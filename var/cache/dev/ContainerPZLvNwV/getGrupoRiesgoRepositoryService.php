...
// Returns the private 'App\Repository\GrupoRiesgoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GrupoRiesgoRepository.php';

return $this->privates['App\Repository\GrupoRiesgoRepository'] = new \App\Repository\GrupoRiesgoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
