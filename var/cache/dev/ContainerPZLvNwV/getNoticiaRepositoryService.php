...
// Returns the private 'App\Repository\NoticiaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NoticiaRepository.php';

return $this->privates['App\Repository\NoticiaRepository'] = new \App\Repository\NoticiaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
