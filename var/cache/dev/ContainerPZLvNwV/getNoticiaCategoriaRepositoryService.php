...
// Returns the private 'App\Repository\NoticiaCategoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NoticiaCategoriaRepository.php';

return $this->privates['App\Repository\NoticiaCategoriaRepository'] = new \App\Repository\NoticiaCategoriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
