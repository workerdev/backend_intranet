...
// Returns the private 'App\Repository\OrganigramaGerenciaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OrganigramaGerenciaRepository.php';

return $this->privates['App\Repository\OrganigramaGerenciaRepository'] = new \App\Repository\OrganigramaGerenciaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
