...
// Returns the private 'App\Repository\EstadoPersonalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoPersonalRepository.php';

return $this->privates['App\Repository\EstadoPersonalRepository'] = new \App\Repository\EstadoPersonalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
