...
// Returns the private 'App\Repository\FichaCargoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FichaCargoRepository.php';

return $this->privates['App\Repository\FichaCargoRepository'] = new \App\Repository\FichaCargoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
