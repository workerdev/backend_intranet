...
// Returns the private 'App\Repository\TipoDocumentoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoDocumentoRepository.php';

return $this->privates['App\Repository\TipoDocumentoRepository'] = new \App\Repository\TipoDocumentoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
