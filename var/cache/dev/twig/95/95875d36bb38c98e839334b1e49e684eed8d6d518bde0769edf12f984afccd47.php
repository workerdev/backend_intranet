...
class __TwigTemplate_cb8a36479a8d543e0927f75e622e7994cd712324e3bc9b346b79c9f5958a23bb extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"header bg-indigo\"><h2>Ficha de Cargos</h2></div>
    <div class=\"body\">
        <div class=\"row clearfix\">
            <div class=\"col-xs-3 col-sm-2 col-md-2 col-lg-2\">
            ";
        // line 30
        if (twig_in_filter("fichacargo_insertar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 30, $this->source); })()))) {
            // line 31
        ...
        ";
        // line 37
        if ((twig_in_filter("home_fichacargo", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 37, $this->source); })())) && (isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new Twig_Error_Runtime('Variable "objects" does not exist.', 37, $this->source); })()))) {
            // line 38
            echo "            <div class=\"row\">
                <div class=\"body table-responsive\">
                    <table id=\"data_tabletr\" class=\"table table-bordered table-striped table-hover js-basic-example dataTable\">
                        ...
                        <tr>
                            ...
                            <th class=\"order_by_th\" data-name=\"phone\">Responsabilidades </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Experiencia </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Conocimientos </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Formacion </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Caracteristicas </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Fecha aprobado </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Aprobado Jefe </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Firma Jefe </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Aprobado Gerente</th>
                            <th class=\"order_by_th\" data-name=\"phone\">Firma Gerente </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Hipervinculo </th>
...
";
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            enabled = false
            swal({
                title: \"¿Desea dar de baja la ficha de cargo?\",
                type: \"warning\",
                ...
                ajax_call(\"/fichacargo_eliminar\", { id,enabled,_xsrf: getCookie(\"_xsrf\")}, null, function () {setTimeout(function(){window.location=main_route}, 2000);S})
            })
        })
    </script>
...
";
    ...
    {
        return array (  154 => 71,  148 => 70,  140 => 68,  136 => 66,  127 => 60,  103 => 38,  101 => 37,  97 => 35,  91 => 31,  89 => 30,  80 => 24,  77 => 23,  71 => 22,  46 => 3,  40 => 2,  15 => 1,);
    }
...
{% endblock %}", "fichacargo/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\fichacargo\\index.html.twig");
    }
}
