...
class __TwigTemplate_1781d2ab1d2f3219d075fdf1efe29dc60d1a67376137e46d40d70d1005588811 extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"body\">
        <div class=\"row clearfix\">
            ...
            ";
        // line 30
        if (twig_in_filter("datoempresarial_insertar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 30, $this->source); })()))) {
            echo "   
        ...
        ";
        // line 37
        if ((twig_in_filter("home_datoempresarial", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 37, $this->source); })())) && (isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new Twig_Error_Runtime('Variable "objects" does not exist.', 37, $this->source); })()))) {
            // line 38
            echo "            <div class=\"row\">
                <div class=\"body table-responsive\">
                    <table id=\"data_tabletr\" class=\"table table-bordered table-striped table-hover js-basic-example dataTable\">
                        ...
                        <tr>
                            ...
                            <th class=\"order_by_th\" data-name=\"names\">Descipcion </th>
                            <th class=\"order_by_th\" data-name=\"phone\">Tipo dato Empresarial </th>
...
";
    ...
    \$('#tipodatoempresarial').selectpicker({
        size: 4,
        liveSearch: true,
        liveSearchPlaceholder: 'Seleccione un tipo de dato Empresarial.',
        title: 'Seleccione un tipo de dato Empresarial.'
    })
    ...
    \$('#insert').click(function () {
        ...
        objeto = JSON.stringify({
            ...
            'tipodatoempresarial': \$('#tipodatoempresarial').val()
        })
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/datoempresarial_editar\",{
                ...
                \$('#tipodatoempresarial').val(self.fktipodatoempresarial.id)
                \$('#tipodatoempresarial').selectpicker('render')
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            enabled = false
            swal({
                title: \"¿Desea dar de baja el datoempresarial?\",
                type: \"warning\",
...
{% endblock %}", "datoempresarial/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\datoempresarial\\index.html.twig");
    }
}
