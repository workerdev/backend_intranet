...
class __TwigTemplate_caca7f0dc70db25e1e401db41688c583cc04dd7b500391a21b71693344306825 extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"body\">
        <div class=\"row clearfix\">
            ...
            ";
        // line 30
        if (twig_in_filter("personalcargo_insertar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 30, $this->source); })()))) {
            // line 31
        ...
        ";
        // line 37
        if ((twig_in_filter("home_personalcargo", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 37, $this->source); })())) && (isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new Twig_Error_Runtime('Variable "objects" does not exist.', 37, $this->source); })()))) {
            // line 38
            echo "            <div class=\"row\">
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            swal({
                ...
                ajax_call(\"/personalcargo_eliminar\", { id,enabled,_xsrf: getCookie(\"_xsrf\")}, null, function () {setTimeout(function(){window.location=main_route}, 2000);S})
            })
        })
    </script>
...
";
    ...
    {
        return array (  145 => 62,  139 => 61,  131 => 59,  127 => 57,  118 => 51,  103 => 38,  101 => 37,  97 => 35,  91 => 31,  89 => 30,  80 => 24,  77 => 23,  71 => 22,  46 => 3,  40 => 2,  15 => 1,);
    }
...
{% endblock %}", "personalcargo/index.html.twig", "C:\\Users\\CHARLY\\Desktop\\elfec_intranet_jan21\\elfec_intranet_backend\\templates\\personalcargo\\index.html.twig");
    }
}
