...
class __TwigTemplate_ab56b65cf873659eb9bfb60aed5b5886bd5ef453370ac0212e960f9a604737b0 extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"header bg-indigo\"><h2>FICHAPROCESOS</h2></div>
    <div class=\"body\">
                ...
                <div class=\"body table-responsive\">
                    <table id=\"data_tabletr\" class=\"table table-bordered table-striped table-hover js-basic-example dataTable\">
                        ...
                        <tr>
                            ...
                            <th class=\"order_by_th\" data-name=\"phone\">Area </th>
...
";
    ...
    \$('#usuario').selectpicker({
        size: 4,
        liveSearch: true,
        liveSearchPlaceholder: 'Buscar tipo de usuario.',
    ...
    \$('#insert').click(function () {
        if(!validate_fields(['nombre', 'objetivo', 'version'])){
            return
        }
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/fichaprocesos_editar\",{
                ...
                \$('#usuario').val(self.fkusuario.id)
                \$('#usuario').selectpicker('render')
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            enabled = false
            swal({
                title: \"¿Desea dar de baja el fichaprocesos?\",
                type: \"warning\",
...
{% endblock %}", "fichaprocesos/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\fichaprocesos\\index.html.twig");
    }
}
