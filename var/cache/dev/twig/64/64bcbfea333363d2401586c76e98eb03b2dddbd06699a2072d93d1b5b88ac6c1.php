...
class __TwigTemplate_8b961ae4c72d06826d2715727967b10127ac83c21ebd369ed18249804c79cfd2 extends Twig_Template
{
    private $source;
                ...
                <div class=\"body table-responsive\">
                    <table id=\"data_tabletr\" class=\"table table-bordered table-striped table-hover js-basic-example dataTable\">
                        ...
                        <tr>
                            ...
                            <th class=\"order_by_th\" data-name=\"phone\">Fecha Nacimiento </th>
...
";
    ...
    \$('#insert').click(function () {
        // if(!validate_fields(['nombre', 'apellido', 'ci', 'correo', 'telefono'])){
        //     return
        // }
        var objeto = JSON.stringify({
            ...
            'fnac': \$('#fnac').val(),
            'personalcargo': \$('#personalcargo').val(),
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/personal_editar\",{
                ...
                \$('#personalcargo').val(self.fkpersonalcargo.id)
                \$('#estadopersonal').val(self.fkestadopersonal.id)
                \$('#personalcargo').selectpicker('render')
