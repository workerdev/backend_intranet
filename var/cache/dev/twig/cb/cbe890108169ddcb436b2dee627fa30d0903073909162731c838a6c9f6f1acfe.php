...
class __TwigTemplate_40e503377b18fb93bda4e6d584fb1dd78f28b467b3c62daa44bbe5ad33250d6b extends Twig_Template
{
    private $source;
...
";
    ...
    \$('#fkfichacargo').selectpicker({
        size: 4,
        liveSearch: true,
        liveSearchPlaceholder: 'Buscar ficha de cargo.',
        title: 'Seleccione una ficha de cargo.'
    })
    ...
    \$('#insert').click(function () {
        objeto = JSON.stringify({
            'fichacargo': \$('#fkfichacargo').val(),
            'documento': \$('#fkdocumento').val()
        })
        ajax_call_validation(\"/documentosaso_insertar\", {object: objeto}, null, main_route)
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/documentosaso_editar\",{
                ...
                \$('#fkfichacargo').val(self.fkfichacargo.id)
                \$('#fkfichacargo').selectpicker('render')
    ...
    \$('#update').click(function () {
        ...
        ajax_call_validation(\"/documentosaso_actualizar\", {object: objeto}, null, main_route)
...
{% endblock %}", "documentosaso/index.html.twig", "C:\\Users\\CHARLY\\Desktop\\elfec_intranet_jan21\\elfec_intranet_backend\\templates\\documentosaso\\index.html.twig");
    }
}
