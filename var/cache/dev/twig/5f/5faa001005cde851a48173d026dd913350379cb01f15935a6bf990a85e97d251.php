...
class __TwigTemplate_5cfc08e3c4af9f104fafbc521b3d0fbe89e94e1450a524751c7a38da19ca0234 extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"body\">
        <div class=\"row clearfix\">
            ...
            ";
        // line 30
        if (twig_in_filter("accion_insertar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 30, $this->source); })()))) {
            // line 31
        ...
        ";
        // line 37
        if ((twig_in_filter("home_accion", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 37, $this->source); })())) && (isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new Twig_Error_Runtime('Variable "objects" does not exist.', 37, $this->source); })()))) {
            // line 38
            echo "            <div class=\"row\">
...
";
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/accion_editar\",{
                ...
                \$('#estado').val(self.estadoaccion)
                \$('#estado').selectpicker('render')

                \$('#hallazgo').val(self.fkhallazgo.id)
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            enabled = false
            swal({
                title: \"¿Desea dar de baja los datos de la acción?\",
                type: \"warning\",
                ...
                ajax_call(\"/accion_eliminar\", { id,enabled,_xsrf: getCookie(\"_xsrf\")}, null, function () {setTimeout(function(){window.location=main_route}, 2000);S})
            })
        })
    </script>
...
{% endblock %}", "accion/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\accion\\index.html.twig");
    }
}
