...
class __TwigTemplate_b23307cfffbdd39ee6179b851b872fda8e65f49f117de7df2efab15552dd5ddb extends Twig_Template
{
    private $source;
...
<div class=\"header bg-indigo\"><h2>TIPO DE CARGO</h2></div>
<div class=\"body\">
    <div class=\"row clearfix\">
        <div class=\"col-xs-3 col-sm-2 col-md-2 col-lg-2\">
        ";
        // line 34
        if (twig_in_filter("tipocargo_insertar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 34, $this->source); })()))) {
            // line 35
    ...
    ";
        // line 41
        if ((twig_in_filter("home_tipocargo", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 41, $this->source); })())) && (isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new Twig_Error_Runtime('Variable "objects" does not exist.', 41, $this->source); })()))) {
            // line 42
            echo "    <div class=\"row\">
...
<script>
    ...
    \$('#insert').click(function () {
        ...
        ajax_call_validation(\"/tipocargo_insertar\", {object: objeto}, null, main_route)
    ...
    \$('#update').click(function () {
        ...
        ajax_call_validation(\"/tipocargo_actualizar\", {object: objeto}, null, main_route)
...
<script>
    ...
    let message= ''
    function tpcargo_prev(id) {
        obj = JSON.stringify({
            'id': parseInt(JSON.parse(id))
        });
        ajax_call_get(\"/tpcargo_prev\",{
            object: obj
        },function(response){
            message = response;
        });
...
{% endblock %}", "tipocargo/index.html.twig", "C:\\Users\\CHARLY\\Desktop\\elfec_intranet_jan21\\Elfec Github\\elfec Backend\\Intranet-Backend\\templates\\TipoCargo\\index.html.twig");
    }
}
