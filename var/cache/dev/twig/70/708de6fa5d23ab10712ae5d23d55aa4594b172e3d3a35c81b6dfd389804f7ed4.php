...
class __TwigTemplate_0492aef77c3add8e72b3e4ce356667857ca25048e86eeed989aaafa3237f99f2 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        <td>";
            // line 6
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tr"], "consecuencia", array()), "html", null, true);
            echo "</td>
        <td>";
            // line 7
        ...
        <td>";
            // line 9
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["tr"], "fkgruporiesgo", array()), "nombre", array()), "html", null, true);
            echo "</td>
        <td>";
            // line 10
...
";
    ...
    {
        return array (  78 => 15,  74 => 14,  69 => 12,  65 => 11,  61 => 10,  57 => 9,  53 => 8,  49 => 7,  45 => 6,  41 => 5,  37 => 4,  33 => 3,  30 => 2,  26 => 1,);
    }
    ...
    <tr>
        ...
        <td>{{ tr.consecuencia }}</td>
        <td>{{ tr.accion }}</td>
        <td>{{ tr.fkficha.nombre }}</td>
        <td>{{ tr.fkgruporiesgo.nombre }}</td>
...
{% endfor %}", "riesgosoportunidades/table.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\riesgosoportunidades\\table.html.twig");
    }
}
