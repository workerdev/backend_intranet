...
/* accioneficacia/table.html.twig */
class __TwigTemplate_3dafc97656d9952227dbab300c31e607ec7b0bd2d2daeffeadb42ed84bd3fa62 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "accioneficacia/table.html.twig"));
        ...
        <td>";
            // line 4
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tr"], "eficaz", array()), "html", null, true);
            echo "</td>
        <td>";
            // line 5
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tr"], "resultado", array()), "html", null, true);
            echo "</td>
        <td>";
            // line 6
        ...
        <td>";
            // line 8
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tr"], "nombreverificador", array()), "html", null, true);
            echo "</td>
        <td>";
            // line 9
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tr"], "cargoverificador", array()), "html", null, true);
            echo "</td>
        <td align=\"center\">
        ";
            // line 11
            if (twig_in_filter("accionseguimiento_editar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 11, $this->source); })()))) {
                // line 12
        ...
        ";
            ...
            // line 14
            echo "        ";
            if (twig_in_filter("accionseguimiento_eliminar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 14, $this->source); })()))) {
                echo "  
...
";
    ...
    {
        return "accioneficacia/table.html.twig";
    }
    ...
    <tr>
        ...
        <td>{{ tr.nombreverificador }}</td>
        <td>{{ tr.cargoverificador }}</td>
        <td align=\"center\">
        {% if 'accionseguimiento_editar' in permisos %}
        ...
        {% endif %}
        {% if 'accionseguimiento_eliminar' in permisos %}  
