...
class __TwigTemplate_ae43a5a907f20b75fafcbc582ada1f91d0313e49ba051c1fe1f5a3fa497b04e8 extends Twig_Template
{
    private $source;
    ...
    ";
            // line 7
            if (twig_in_filter("probabilidad_editar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 7, $this->source); })()))) {
                // line 8
    ...
    ";
            ...
            // line 10
            echo "    ";
            if (twig_in_filter("probabilidad_eliminar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 10, $this->source); })()))) {
                echo "  
...
<tr>
    ...
    <td>{{ t.valor }}</td>
    <td align=\"center\">
    {% if 'probabilidad_editar' in permisos %}
    ...
    {% endif %}
    {% if 'probabilidad_eliminar' in permisos %}  
