...
class __TwigTemplate_31d50076774e7341b14d3c9cd170f977f6f36c6a708df2ec1b477a3f3721a963 extends Twig_Template
{
    private $source;
...
<div class=\"header bg-indigo\"><h2>Enlaces</h2></div>
<div class=\"body\">
        ...
        <div class=\"body table-responsive\">
            <table id=\"data_table\" class=\"table table-bordered table-striped table-hover js-basic-example dataTable\">
                ...
                <tr>
                    ...
                    <th class=\"order_by_th\" data-name=\"phone\">Link </th>
...
<script>
    ...
    \$('#insert').click(function () {
        if(!validate_fields(['nombre', 'link'])){
            return
        }
        ...
        ajax_call(\"/enlaces_insertar\", {object: objeto}, null, function () {setTimeout(function(){window.location=main_route}, 2000);})
        \$('#form').modal('hide')
    })
...
<script>
    ...
    \$('.delete').click(function () {
        ...
        enabled = false
        swal({
            title: \"¿Desea dar de baja el tipo de enlaces?\",
            type: \"warning\",
...
{% endblock %}", "enlaces/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\enlaces\\index.html.twig");
    }
}
