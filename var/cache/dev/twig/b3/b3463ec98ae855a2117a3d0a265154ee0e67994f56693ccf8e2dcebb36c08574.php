...
/* auditoriaequipo/table.html.twig */
class __TwigTemplate_cfdb19d5abbfbf236e4c516a422850e793141842ec098315a56f0abf853226f1 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "auditoriaequipo/table.html.twig"));
    ...
    <td>";
            // line 5
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["t"], "fkauditor", array()), "apellidosnombres", array()), "html", null, true);
            echo "</td>
    <td>";
            // line 6
    ...
    ";
            // line 8
            if (twig_in_filter("auditoriaequipo_editar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 8, $this->source); })()))) {
                // line 9
    ...
    ";
            ...
            // line 11
            echo "    ";
            if (twig_in_filter("auditoriaequipo_eliminar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 11, $this->source); })()))) {
                echo "  
...
";
    ...
    {
        return "auditoriaequipo/table.html.twig";
    }
...
<tr>
    ...
    <td>{{ t.fkauditor.apellidosnombres }}</td>
    <td>{{ t.fktipo.nombre }}</td>
    <td align=\"center\">
    {% if 'auditoriaequipo_editar' in permisos %}
    ...
    {% endif %}
    {% if 'auditoriaequipo_eliminar' in permisos %}  
...
{% endfor %}", "auditoriaequipo/table.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\auditoriaequipo\\table.html.twig");
    }
}
