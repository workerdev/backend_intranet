...
/* procesorelacionado/table.html.twig */
class __TwigTemplate_7670217a1abfda0f772cf28e6060cce2d95566099bb42c84ab8df94fe79a9e6d extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "procesorelacionado/table.html.twig"));
        ...
        <td>";
            // line 4
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["tr"], "fkprocesorel", array()), "nombre", array()), "html", null, true);
            echo "</td>
        <td align=\"center\">
        ";
            // line 6
            if (twig_in_filter("procesorelacionado_editar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 6, $this->source); })()))) {
                // line 7
        ...
        ";
            ...
            // line 9
            echo "        ";
            if (twig_in_filter("procesorelacionado_eliminar", (isset($context["permisos"]) || array_key_exists("permisos", $context) ? $context["permisos"] : (function () { throw new Twig_Error_Runtime('Variable "permisos" does not exist.', 9, $this->source); })()))) {
                echo "  
...
";
    ...
    {
        return "procesorelacionado/table.html.twig";
    }
    ...
    <tr>
        ...
        <td>{{ tr.fkprocesorel.nombre }}</td>
        <td align=\"center\">
        {% if 'procesorelacionado_editar' in permisos %}
        ...
        {% endif %}
        {% if 'procesorelacionado_eliminar' in permisos %}  
...
{% endfor %}", "procesorelacionado/table.html.twig", "C:\\Users\\CHARLY\\Desktop\\elfec_intranet_jan21\\elfec_intranet_backend\\templates\\procesorelacionado\\table.html.twig");
    }
}
