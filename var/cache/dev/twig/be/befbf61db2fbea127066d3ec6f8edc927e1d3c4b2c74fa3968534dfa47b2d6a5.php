...
class __TwigTemplate_f464b2f42e94fc5bfe0227f30d3c2300d582255dd74978fcd72c3d2b5b2db0ae extends Twig_Template
{
    private $source;
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/turno_editar\",{
                ...
                \$('#id').val(self.id)
                \$('#turno').val(self.turno)
                \$('#descripcion').val(self.descripcion)

                \$('#personal').val(self.fkpersonal.id)
                \$('#personal').selectpicker('render')
...
";
    ...
    {
        return array (  136 => 58,  130 => 57,  122 => 55,  118 => 53,  109 => 47,  96 => 36,  94 => 35,  80 => 24,  77 => 23,  71 => 22,  46 => 3,  40 => 2,  15 => 1,);
    }
...
{% endblock %}", "turno/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\turno\\index.html.twig");
    }
}
