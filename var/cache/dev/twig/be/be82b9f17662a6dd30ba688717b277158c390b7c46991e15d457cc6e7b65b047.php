...
class __TwigTemplate_1166e313f4b1dabed7aa6c9d835bdd6f0d2fbdce89304f1ad174daf8d37a7dee extends Twig_Template
{
    private $source;
...
";
    ...
    <div class=\"header bg-indigo\"><h2>Seguimiento Elab.</h2></div>
    <div class=\"body\">
...
";
    ...
    function attach_edit() {
        \$('.edit').click(function () {
            ...
            ajax_call_get(\"/seguimientoelaboracion_editar\",{
                ...
                \$('#revisor').val(self.fkrevisor.id)
                \$('#revisor').selectpicker('render')
    ...
    <script>
        ...
        \$('.delete').click(function () {
            ...
            enabled = false
            swal({
                title: \"¿Desea dar de baja el seguimiento elaboración?\",
                type: \"warning\",
...
{% endblock %}", "seguimientoelaboracion/index.html.twig", "C:\\xampp\\htdocs\\elfec_intranet_backend\\templates\\seguimientoelaboracion\\index.html.twig");
    }
}
