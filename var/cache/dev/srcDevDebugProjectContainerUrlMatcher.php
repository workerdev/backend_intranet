        ...
        switch ($trimmedPathinfo) {
            default:
                $routes = [
                    ...
                    '/correlativo_b64file' => [['_route' => 'correlativo_b64file', '_controller' => 'App\\Controller\\CorrelativoController::b64file'], null, ['POST' => 0], null, false],
                    ...
                    '/enviarcorreo' => [['_route' => 'enviarcorreo', '_controller' => 'App\\Controller\\ServiciosController::enviarcorreo'], null, ['POST' => 0], null, false],
                    '/enviarcorreo_buzon' => [['_route' => 'enviarcorreo_buzon', '_controller' => 'App\\Controller\\ServiciosController::enviarcorreo_buzon'], null, ['POST' => 0], null, false],
                    '/organigrama2' => [['_route' => 'organigrama2', '_controller' => 'App\\Controller\\ServiciosController::organigrama'], null, ['GET' => 0], null, false],
                    '/organigrama_por_cargo' => [['_route' => 'organigrama_por_cargo', '_controller' => 'App\\Controller\\ServiciosController::organigrama_por_cargo'], null, ['POST' => 0], null, false],
                    ...
                    '/sigprocfcgerencia' => [['_route' => 'procesogerencia', '_controller' => 'App\\Controller\\ServiciosController::procesogerencia'], null, ['GET' => 0], null, false],
                    ...
                    '/sigprocfcprocesos' => [['_route' => 'procesoprocesos', '_controller' => 'App\\Controller\\ServiciosController::sigprocesoprocesos'], null, ['GET' => 0], null, false],
                    ...
                    '/listar_audhlg' => [['_route' => 'listar_audhlg', '_controller' => 'App\\Controller\\ServiciosController::listar_audhlg'], null, ['GET' => 0], null, false],
                    ...
                    '/listar_hallazgo' => [['_route' => 'listar_hallazgo', '_controller' => 'App\\Controller\\ServiciosController::listar_hallazgo'], null, ['GET' => 0], null, false],
                    '/listar_accion' => [['_route' => 'listar_accion', '_controller' => 'App\\Controller\\ServiciosController::listar_accion'], null, ['GET' => 0], null, false],
                    '/dethlg_idac' => [['_route' => 'dethlg_idac', '_controller' => 'App\\Controller\\ServiciosController::dethlg_idac'], null, ['POST' => 0], null, false],
                    '/listar_verificaref' => [['_route' => 'listar_verificaref', '_controller' => 'App\\Controller\\ServiciosController::listar_verificaref'], null, ['GET' => 0], null, false],
                    '/listar_fortaleza' => [['_route' => 'listar_fortaleza', '_controller' => 'App\\Controller\\ServiciosController::listar_fortaleza'], null, ['GET' => 0], null, false],
                    '/crocm_list' => [['_route' => 'crocm_list', '_controller' => 'App\\Controller\\ServiciosController::crocm_list'], null, ['POST' => 0], null, false],
                    '/crocm_consulta' => [['_route' => 'crocm_consulta', '_controller' => 'App\\Controller\\ServiciosController::crocm_consulta'], null, ['POST' => 0], null, false],
                    ...
                    '/combo_proceso' => [['_route' => 'combo_proceso', '_controller' => 'App\\Controller\\ServiciosController::combo_proceso'], null, ['GET' => 0], null, false],
                    '/combo_tipocrocm' => [['_route' => 'combo_tipocrocm', '_controller' => 'App\\Controller\\ServiciosController::combo_tipocrocm'], null, ['GET' => 0], null, false],
                    '/combo_probabilidad' => [['_route' => 'combo_probabilidad', '_controller' => 'App\\Controller\\ServiciosController::combo_probabilidad'], null, ['GET' => 0], null, false],
                    '/combo_impacto' => [['_route' => 'combo_impacto', '_controller' => 'App\\Controller\\ServiciosController::combo_impacto'], null, ['GET' => 0], null, false],
                    '/combo_responsable' => [['_route' => 'combo_responsable', '_controller' => 'App\\Controller\\ServiciosController::combo_responsable'], null, ['GET' => 0], null, false],
                    ...
                    '/combo_org_cargo' => [['_route' => 'combo_org_cargo', '_controller' => 'App\\Controller\\ServiciosController::combo_org_cargo'], null, ['GET' => 0], null, false],
                    '/combo_organigrama' => [['_route' => 'combo_organigrama', '_controller' => 'App\\Controller\\ServiciosController::combo_organigrama'], null, ['GET' => 0], null, false],
                    '/listar_cobertura' => [['_route' => 'listar_cobertura', '_controller' => 'App\\Controller\\ServiciosController::listar_cobertura'], null, ['POST' => 0], null, false],
                    ...
                    '/tipoaccion' => [['_route' => 'tipoaccion', '_controller' => 'App\\Controller\\TipoAccionController::index'], null, null, null, false],
                    '/tipoaccion_insertar' => [['_route' => 'tipoaccion_insertar', '_controller' => 'App\\Controller\\TipoAccionController::insertar'], null, ['POST' => 0], null, false],
                    '/tipoaccion_actualizar' => [['_route' => 'tipoaccion_actualizar', '_controller' => 'App\\Controller\\TipoAccionController::actualizar'], null, ['POST' => 0], null, false],
                    '/tipoaccion_editar' => [['_route' => 'tipoaccion_editar', '_controller' => 'App\\Controller\\TipoAccionController::editar'], null, ['POST' => 0], null, false],
                    '/tipoacn_prev' => [['_route' => 'tipoacn_prev', '_controller' => 'App\\Controller\\TipoAccionController::tipoacn_prev'], null, ['POST' => 0], null, false],
                    '/tipoaccion_eliminar' => [['_route' => 'tipoaccion_eliminar', '_controller' => 'App\\Controller\\TipoAccionController::eliminar'], null, ['POST' => 0], null, false],
