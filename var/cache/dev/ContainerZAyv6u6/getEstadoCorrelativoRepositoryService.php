...
// Returns the private 'App\Repository\EstadoCorrelativoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoCorrelativoRepository.php';

return $this->privates['App\Repository\EstadoCorrelativoRepository'] = new \App\Repository\EstadoCorrelativoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
