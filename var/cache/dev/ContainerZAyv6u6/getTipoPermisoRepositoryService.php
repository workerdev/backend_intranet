...
// Returns the private 'App\Repository\TipoPermisoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoPermisoRepository.php';

return $this->privates['App\Repository\TipoPermisoRepository'] = new \App\Repository\TipoPermisoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
