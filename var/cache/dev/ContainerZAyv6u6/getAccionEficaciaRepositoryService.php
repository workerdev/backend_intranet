...
// Returns the private 'App\Repository\AccionEficaciaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccionEficaciaRepository.php';

return $this->privates['App\Repository\AccionEficaciaRepository'] = new \App\Repository\AccionEficaciaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
