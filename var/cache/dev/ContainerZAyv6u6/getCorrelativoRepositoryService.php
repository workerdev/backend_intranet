...
// Returns the private 'App\Repository\CorrelativoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CorrelativoRepository.php';

return $this->privates['App\Repository\CorrelativoRepository'] = new \App\Repository\CorrelativoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
