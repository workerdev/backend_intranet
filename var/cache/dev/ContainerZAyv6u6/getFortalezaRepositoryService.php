...
// Returns the private 'App\Repository\FortalezaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FortalezaRepository.php';

return $this->privates['App\Repository\FortalezaRepository'] = new \App\Repository\FortalezaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
