...
// Returns the private 'App\Repository\ResponsabilidadSocialRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ResponsabilidadSocialRepository.php';

return $this->privates['App\Repository\ResponsabilidadSocialRepository'] = new \App\Repository\ResponsabilidadSocialRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
