...
// Returns the private 'App\Repository\FilesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\FilesRepository.php';

return $this->privates['App\Repository\FilesRepository'] = new \App\Repository\FilesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
