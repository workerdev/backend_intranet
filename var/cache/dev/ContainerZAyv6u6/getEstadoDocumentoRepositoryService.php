...
// Returns the private 'App\Repository\EstadoDocumentoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoDocumentoRepository.php';

return $this->privates['App\Repository\EstadoDocumentoRepository'] = new \App\Repository\EstadoDocumentoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
