...
// Returns the private 'App\Repository\EstadoNovedadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoNovedadRepository.php';

return $this->privates['App\Repository\EstadoNovedadRepository'] = new \App\Repository\EstadoNovedadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
