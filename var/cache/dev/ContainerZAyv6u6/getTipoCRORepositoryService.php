...
// Returns the private 'App\Repository\TipoCRORepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoCRORepository.php';

return $this->privates['App\Repository\TipoCRORepository'] = new \App\Repository\TipoCRORepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
