...
// Returns the private 'App\Repository\EnlacesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EnlacesRepository.php';

return $this->privates['App\Repository\EnlacesRepository'] = new \App\Repository\EnlacesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
