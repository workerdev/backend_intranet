...
// Returns the private 'App\Repository\TipoAuditorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoAuditorRepository.php';

return $this->privates['App\Repository\TipoAuditorRepository'] = new \App\Repository\TipoAuditorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
