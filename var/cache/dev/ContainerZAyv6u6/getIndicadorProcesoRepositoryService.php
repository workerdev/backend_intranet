...
// Returns the private 'App\Repository\IndicadorProcesoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\IndicadorProcesoRepository.php';

return $this->privates['App\Repository\IndicadorProcesoRepository'] = new \App\Repository\IndicadorProcesoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
