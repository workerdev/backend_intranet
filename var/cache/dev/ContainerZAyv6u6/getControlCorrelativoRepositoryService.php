...
// Returns the private 'App\Repository\ControlCorrelativoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ControlCorrelativoRepository.php';

return $this->privates['App\Repository\ControlCorrelativoRepository'] = new \App\Repository\ControlCorrelativoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
