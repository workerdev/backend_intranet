...
// Returns the private 'App\Repository\DetalleDocumentoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DetalleDocumentoRepository.php';

return $this->privates['App\Repository\DetalleDocumentoRepository'] = new \App\Repository\DetalleDocumentoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
