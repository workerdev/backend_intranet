...
// Returns the private 'App\Repository\ProcesosCargoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProcesosCargoRepository.php';

return $this->privates['App\Repository\ProcesosCargoRepository'] = new \App\Repository\ProcesosCargoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
