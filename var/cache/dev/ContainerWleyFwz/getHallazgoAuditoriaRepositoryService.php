...
// Returns the private 'App\Repository\HallazgoAuditoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HallazgoAuditoriaRepository.php';

return $this->privates['App\Repository\HallazgoAuditoriaRepository'] = new \App\Repository\HallazgoAuditoriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
