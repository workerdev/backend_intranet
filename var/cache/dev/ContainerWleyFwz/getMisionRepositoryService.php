...
// Returns the private 'App\Repository\MisionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MisionRepository.php';

return $this->privates['App\Repository\MisionRepository'] = new \App\Repository\MisionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
