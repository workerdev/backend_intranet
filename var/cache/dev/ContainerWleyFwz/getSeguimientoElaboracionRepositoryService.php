...
// Returns the private 'App\Repository\SeguimientoElaboracionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SeguimientoElaboracionRepository.php';

return $this->privates['App\Repository\SeguimientoElaboracionRepository'] = new \App\Repository\SeguimientoElaboracionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
