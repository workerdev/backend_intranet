...
// Returns the private 'App\Repository\DocumentacionAdicionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentacionAdicionalRepository.php';

return $this->privates['App\Repository\DocumentacionAdicionalRepository'] = new \App\Repository\DocumentacionAdicionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
