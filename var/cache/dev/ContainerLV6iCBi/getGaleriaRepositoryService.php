...
// Returns the private 'App\Repository\GaleriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GaleriaRepository.php';

return $this->privates['App\Repository\GaleriaRepository'] = new \App\Repository\GaleriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
