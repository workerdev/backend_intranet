...
// Returns the private 'App\Repository\AuditoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AuditoriaRepository.php';

return $this->privates['App\Repository\AuditoriaRepository'] = new \App\Repository\AuditoriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
