...
// Returns the private 'App\Repository\TipoCargoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoCargoRepository.php';

return $this->privates['App\Repository\TipoCargoRepository'] = new \App\Repository\TipoCargoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
