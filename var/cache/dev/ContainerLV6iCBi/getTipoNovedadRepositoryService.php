...
// Returns the private 'App\Repository\TipoNovedadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoNovedadRepository.php';

return $this->privates['App\Repository\TipoNovedadRepository'] = new \App\Repository\TipoNovedadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
