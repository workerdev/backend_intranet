...
// Returns the private 'App\Repository\ConstitucionalesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ConstitucionalesRepository.php';

return $this->privates['App\Repository\ConstitucionalesRepository'] = new \App\Repository\ConstitucionalesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
