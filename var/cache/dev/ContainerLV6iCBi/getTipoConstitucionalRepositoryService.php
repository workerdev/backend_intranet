...
// Returns the private 'App\Repository\TipoConstitucionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoConstitucionalRepository.php';

return $this->privates['App\Repository\TipoConstitucionalRepository'] = new \App\Repository\TipoConstitucionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
