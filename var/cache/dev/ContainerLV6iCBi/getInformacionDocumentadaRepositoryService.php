...
// Returns the private 'App\Repository\InformacionDocumentadaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InformacionDocumentadaRepository.php';

return $this->privates['App\Repository\InformacionDocumentadaRepository'] = new \App\Repository\InformacionDocumentadaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
