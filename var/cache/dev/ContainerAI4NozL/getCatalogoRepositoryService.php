...
// Returns the private 'App\Repository\CatalogoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CatalogoRepository.php';

return $this->privates['App\Repository\CatalogoRepository'] = new \App\Repository\CatalogoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
