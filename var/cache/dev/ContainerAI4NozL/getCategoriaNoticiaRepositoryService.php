...
// Returns the private 'App\Repository\CategoriaNoticiaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CategoriaNoticiaRepository.php';

return $this->privates['App\Repository\CategoriaNoticiaRepository'] = new \App\Repository\CategoriaNoticiaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
