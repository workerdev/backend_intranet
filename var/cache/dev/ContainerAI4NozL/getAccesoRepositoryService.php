...
// Returns the private 'App\Repository\AccesoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccesoRepository.php';

return $this->privates['App\Repository\AccesoRepository'] = new \App\Repository\AccesoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
