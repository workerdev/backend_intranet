...
// Returns the private 'App\Repository\ProcesoRelacionadoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProcesoRelacionadoRepository.php';

return $this->privates['App\Repository\ProcesoRelacionadoRepository'] = new \App\Repository\ProcesoRelacionadoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
