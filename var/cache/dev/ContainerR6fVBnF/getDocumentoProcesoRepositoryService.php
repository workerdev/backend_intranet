...
// Returns the private 'App\Repository\DocumentoProcesoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentoProcesoRepository.php';

return $this->privates['App\Repository\DocumentoProcesoRepository'] = new \App\Repository\DocumentoProcesoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
