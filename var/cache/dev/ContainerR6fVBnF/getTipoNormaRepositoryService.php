...
// Returns the private 'App\Repository\TipoNormaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoNormaRepository.php';

return $this->privates['App\Repository\TipoNormaRepository'] = new \App\Repository\TipoNormaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
