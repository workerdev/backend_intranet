...
// Returns the private 'App\Repository\AccidentesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccidentesRepository.php';

return $this->privates['App\Repository\AccidentesRepository'] = new \App\Repository\AccidentesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
