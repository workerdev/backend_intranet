...
// Returns the private 'App\Repository\PersonalCargoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PersonalCargoRepository.php';

return $this->privates['App\Repository\PersonalCargoRepository'] = new \App\Repository\PersonalCargoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
