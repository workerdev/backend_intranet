...
// Returns the private 'App\Repository\DocumentoExtraRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentoExtraRepository.php';

return $this->privates['App\Repository\DocumentoExtraRepository'] = new \App\Repository\DocumentoExtraRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
