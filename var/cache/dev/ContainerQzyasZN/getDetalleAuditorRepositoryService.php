...
// Returns the private 'App\Repository\DetalleAuditorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DetalleAuditorRepository.php';

return $this->privates['App\Repository\DetalleAuditorRepository'] = new \App\Repository\DetalleAuditorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
