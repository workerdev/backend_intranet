...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\LoadInfoCommand' => function (): \App\Command\LoadInfoCommand {
    return ($this->privates['App\Command\LoadInfoCommand'] ?? $this->load('getLoadInfoCommandService.php'));
}, 'app.command.load_info' => function (): \App\Command\LoadInfoCommand {
    return ($this->privates['app.command.load_info'] ?? $this->load('getApp_Command_LoadInfoService.php'));
