...
// Returns the private 'App\Repository\DocProcRevisionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocProcRevisionRepository.php';

return $this->privates['App\Repository\DocProcRevisionRepository'] = new \App\Repository\DocProcRevisionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
