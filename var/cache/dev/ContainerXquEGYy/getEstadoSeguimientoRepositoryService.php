...
// Returns the private 'App\Repository\EstadoSeguimientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoSeguimientoRepository.php';

return $this->privates['App\Repository\EstadoSeguimientoRepository'] = new \App\Repository\EstadoSeguimientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
