...
// Returns the private 'App\Repository\GerenciaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GerenciaRepository.php';

return $this->privates['App\Repository\GerenciaRepository'] = new \App\Repository\GerenciaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
