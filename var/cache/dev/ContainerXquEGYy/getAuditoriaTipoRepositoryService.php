...
// Returns the private 'App\Repository\AuditoriaTipoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AuditoriaTipoRepository.php';

return $this->privates['App\Repository\AuditoriaTipoRepository'] = new \App\Repository\AuditoriaTipoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
