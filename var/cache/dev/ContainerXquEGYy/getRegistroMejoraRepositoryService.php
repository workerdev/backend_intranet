...
// Returns the private 'App\Repository\RegistroMejoraRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RegistroMejoraRepository.php';

return $this->privates['App\Repository\RegistroMejoraRepository'] = new \App\Repository\RegistroMejoraRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
