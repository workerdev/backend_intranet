...
// Returns the private 'App\Repository\EstadoRiesgoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EstadoRiesgoRepository.php';

return $this->privates['App\Repository\EstadoRiesgoRepository'] = new \App\Repository\EstadoRiesgoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
