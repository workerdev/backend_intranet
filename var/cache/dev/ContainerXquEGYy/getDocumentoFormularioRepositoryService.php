...
// Returns the private 'App\Repository\DocumentoFormularioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\DocumentoFormularioRepository.php';

return $this->privates['App\Repository\DocumentoFormularioRepository'] = new \App\Repository\DocumentoFormularioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
