...
// Returns the private 'App\Repository\TipoAuditoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoAuditoriaRepository.php';

return $this->privates['App\Repository\TipoAuditoriaRepository'] = new \App\Repository\TipoAuditoriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
