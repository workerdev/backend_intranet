...
// Returns the private 'App\Repository\SectorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SectorRepository.php';

return $this->privates['App\Repository\SectorRepository'] = new \App\Repository\SectorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
