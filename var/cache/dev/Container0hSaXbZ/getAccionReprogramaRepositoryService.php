...
// Returns the private 'App\Repository\AccionReprogramaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccionReprogramaRepository.php';

return $this->privates['App\Repository\AccionReprogramaRepository'] = new \App\Repository\AccionReprogramaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
