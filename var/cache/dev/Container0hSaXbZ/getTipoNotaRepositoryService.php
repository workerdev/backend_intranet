...
// Returns the private 'App\Repository\TipoNotaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TipoNotaRepository.php';

return $this->privates['App\Repository\TipoNotaRepository'] = new \App\Repository\TipoNotaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
