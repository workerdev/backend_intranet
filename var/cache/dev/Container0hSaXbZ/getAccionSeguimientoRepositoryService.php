...
// Returns the private 'App\Repository\AccionSeguimientoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AccionSeguimientoRepository.php';

return $this->privates['App\Repository\AccionSeguimientoRepository'] = new \App\Repository\AccionSeguimientoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
