...
// Returns the private 'App\Repository\SeguimientoMejoraRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SeguimientoMejoraRepository.php';

return $this->privates['App\Repository\SeguimientoMejoraRepository'] = new \App\Repository\SeguimientoMejoraRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
