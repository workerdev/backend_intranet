...
// Returns the private 'App\Repository\HallazgoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\HallazgoRepository.php';

return $this->privates['App\Repository\HallazgoRepository'] = new \App\Repository\HallazgoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
